...
- [ ] **Phase 1 — Fly camera**: first-person mouse-look + WASD free-fly, one test cube rendered with `BasicEffect`
- [ ] **Phase 2 — One chunk meshed**: 16×128×16 terrain chunk from a noise heightmap, culled meshing, per-face shading
